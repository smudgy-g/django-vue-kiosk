<template>
  <div class="bg-white">
    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/login" class="font-semibold text-gray-900 text-sm/6"
    ...
    <main class="isolate">
      ...
      <div class="px-6 mx-auto mt-32 max-w-7xl sm:mt-56 lg:px-8">
        <div class="max-w-2xl mx-auto lg:text-center">
          <h2 class="font-semibold text-indigo-600 text-base/7">Deploy faster</h2>
          <p
            class="mt-2 text-4xl font-semibold tracking-tight text-gray-900 text-pretty sm:text-5xl lg:text-balance"
          >
            Everything you need to deploy your app
          </p>
          <p class="mt-6 text-gray-600 text-pretty text-lg/8">
          ...
          >
            <div v-for="feature in features" :key="feature.name" class="relative pl-16">
              <dt class="font-semibold text-gray-900 text-base/7">
                <div
                  class="absolute top-0 left-0 flex items-center justify-center bg-indigo-600 rounded-lg size-10"
                >
                  <component :is="feature.icon" class="text-white size-6" aria-hidden="true" />
                </div>
                {{ feature.name }}
              </dt>
              <dd class="mt-2 text-gray-600 text-base/7">{{ feature.description }}</dd>
            </div>
          </dl>
        </div>
      </div>
      ...
      <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
        ...
        >
          <img
            class="absolute inset-0 object-cover size-full brightness-150 saturate-0"
          ...
          >
            ...
            >
              <div>
                ...
                <p class="mt-4 text-gray-600 text-sm/6">{{ tier.description }}</p>
                ...
                <ul role="list" class="mt-8 space-y-3 text-gray-600 text-sm/6">
                  <li v-for="feature in tier.features" :key="feature" class="flex gap-x-3">
                    <CheckIcon class="flex-none w-5 h-6 text-indigo-600" aria-hidden="true" />
                    {{ feature }}
                  </li>
                </ul>
              </div>
      ...
      >
        ...
        <dl class="mt-10 space-y-8 divide-y divide-gray-900/10">
          <div v-for="faq in faqs" :key="faq.id" class="pt-8 lg:grid lg:grid-cols-12 lg:gap-8">
            <dt class="font-semibold text-gray-900 text-base/7 lg:col-span-5">
              {{ faq.question }}
            </dt>
            <dd class="mt-4 lg:col-span-7 lg:mt-0">
              <p class="text-gray-600 text-base/7">{{ faq.answer }}</p>
            </dd>
          </div>
        </dl>
      </div>
      ...
      <div class="relative px-6 mt-32 -z-10 lg:px-8">
        ...
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="max-w-xl mx-auto mt-6 text-gray-600 text-pretty text-lg/8">
        ...
        <div
          class="absolute right-0 hidden overflow-hidden -translate-y-1/2 left-1/2 top-full -z-10 transform-gpu blur-3xl sm:block"
          aria-hidden="true"
        >
          <div
    ...
    <!-- Footer -->
    <footer class="relative px-6 mx-auto mt-32 max-w-7xl lg:px-8">
      <div class="py-16 border-t border-gray-900/10 sm:py-24 lg:py-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="grid grid-cols-2 gap-8 mt-16 xl:col-span-2 xl:mt-0">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="font-semibold text-gray-900 text-sm/6">Solutions</h3>
                <ul role="list" class="mt-6 space-y-4">
                  <li v-for="item in footerNavigation.solutions" :key="item.name">
                    <a :href="item.href" class="text-gray-600 text-sm/6 hover:text-gray-900">{{
                      item.name
                    }}</a>
                  </li>
                </ul>
              ...
              <div class="mt-10 md:mt-0">
                <h3 class="font-semibold text-gray-900 text-sm/6">Support</h3>
                <ul role="list" class="mt-6 space-y-4">
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="font-semibold text-gray-900 text-sm/6">Company</h3>
                <ul role="list" class="mt-6 space-y-4">
              ...
              <div class="mt-10 md:mt-0">
                <h3 class="font-semibold text-gray-900 text-sm/6">Legal</h3>
                <ul role="list" class="mt-6 space-y-4">
