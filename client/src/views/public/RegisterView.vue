        ...
        <div class="px-4 py-6 sm:p-8">
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-4">
              <label for="website" class="block font-medium text-gray-900 text-sm/6">Website</label>
              <div class="mt-2">
                <div
            ...
            <div class="col-span-full">
              <label for="about" class="block font-medium text-gray-900 text-sm/6">About</label>
              <div class="mt-2">
                <textarea
                  id="about"
                  name="about"
            ...
            <div class="col-span-full">
              ...
              <div class="flex items-center mt-2 gap-x-3">
                <UserCircleIcon class="text-gray-300 size-12" aria-hidden="true" />
                <button
                  type="button"
            ...
            <div class="col-span-full">
              <label for="cover-photo" class="block font-medium text-gray-900 text-sm/6"
                >Cover photo</label
              >
              <div
              ...
              >
                <div class="text-center">
                  <PhotoIcon class="mx-auto text-gray-300 size-12" aria-hidden="true" />
        ...
        <div class="px-4 py-6 sm:p-8">
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
              <label for="first-name" class="block font-medium text-gray-900 text-sm/6"
                >First name</label
              >
              <div class="mt-2">
                <input
            ...
            <div class="sm:col-span-3">
              <label for="last-name" class="block font-medium text-gray-900 text-sm/6"
                >Last name</label
              >
              <div class="mt-2">
                <input
            ...
            <div class="col-span-full">
              <label for="street-address" class="block font-medium text-gray-900 text-sm/6"
            ...
            <div class="sm:col-span-2">
              <label for="region" class="block font-medium text-gray-900 text-sm/6"
            ...
            <div class="sm:col-span-2">
              <label for="postal-code" class="block font-medium text-gray-900 text-sm/6"
                ...
                <div class="relative flex gap-x-3">
                  <div class="flex items-center h-6">
                    <input
                      ...
                      name="comments"
                      type="checkbox"
                      class="text-indigo-600 border-gray-300 rounded size-4 focus:ring-indigo-600"
                    />
                  </div>
                  <div class="text-sm/6">
              ...
              <div class="mt-6 space-y-6">
                <div class="flex items-center gap-x-3">
                  <input
                    ...
                    type="radio"
                    class="text-indigo-600 border-gray-300 size-4 focus:ring-indigo-600"
                  />
                  <label for="push-everything" class="block font-medium text-gray-900 text-sm/6"
                    >Everything</label
                  >
                </div>
                <div class="flex items-center gap-x-3">
                  <input
                    ...
                    class="text-indigo-600 border-gray-300 size-4 focus:ring-indigo-600"
                  />
                  <label for="push-email" class="block font-medium text-gray-900 text-sm/6"
                    >Same as email</label
                  >
                </div>
                <div class="flex items-center gap-x-3">
                  <input
                    ...
                    class="text-indigo-600 border-gray-300 size-4 focus:ring-indigo-600"
                  />
                  <label for="push-nothing" class="block font-medium text-gray-900 text-sm/6"
