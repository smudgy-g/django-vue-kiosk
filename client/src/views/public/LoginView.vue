  ...
  <div class="flex flex-col justify-center flex-1 min-h-full py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img
        ...
        alt="Your Company"
      />
      <h2 class="mt-6 font-bold tracking-tight text-center text-gray-900 text-2xl/9">
      ...
      <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
        <form class="space-y-6" action="#" method="POST">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              />
              <label for="remember-me" class="block ml-3 text-gray-900 text-sm/6"
                >Remember me</label
              >
            </div>
        ...
        <div>
          <div class="relative mt-10">
            ...
            <div class="relative flex justify-center font-medium text-sm/6">
          ...
          <div class="grid grid-cols-2 gap-4 mt-6">
            ...
            >
              ...
              <span class="font-semibold text-sm/6">Google</span>
            </a>
            ...
            >
              ...
              <span class="font-semibold text-sm/6">GitHub</span>
            </a>
          </div>
        </div>
      </div>
